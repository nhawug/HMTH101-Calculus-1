...
\examdate{November/December 2013}
\hours{2}
\lastA{4}
\rubric{\science}
\lastpage{3}
...
\begin{question}
\begin{itemize}
\item[(a)] Solve the following inequality $\dfrac{2x+3}{x-5}>3$ .
\item[(b)] Show that $|x+y|\leq |x|+|y|$ for all $x,y\in \mathbb{R}$.
...
(i)\, $\displaystyle \lim _{n\rightarrow \infty}(\sqrt{n+8}-\sqrt{n})$,\quad  \quad (ii)\, $\displaystyle \lim _{n\rightarrow \infty} \dfrac{5n^4-7n^2+5}{9n^4+3n^3+n^2+1}$. \marks{3,3} 
\end{itemize}
\end{question}
\begin{question}
\begin{itemize}
\item[(a)] Estimate the value of $\sqrt[5]{36}$ using differentials. \marks{4}
\item[(b)] Use the Mean Value Theorem to prove that $\sqrt{1+x}<1+\frac{1}{2}x$ for $x>0$.\marks{5}
\end{itemize}
\end{question}
\begin{question}
\begin{itemize}
\item[(a)] Show that $\displaystyle \int _0^1 x^2\tan ^{-1} x\, dx =\dfrac{\pi}{12}-\dfrac{1}{6}+\dfrac{1}{6}\ln 2$. \marks{6}
\item[(b)] Find each of the following integrals.\\
(i)\, $\displaystyle \int \cos ^5 x\, dx$ \quad \quad \quad (ii)\, $\displaystyle \int \dfrac{dx}{1+\sin x}$. \marks{5,4}
\end{itemize}
\end{question}
\newpage
\sectionBscience
...
\item[(ii)] Show using the definition, that $\displaystyle \lim _{n\rightarrow \infty}(1-2n) =-\infty$. 
...
(i)\, $\displaystyle \lim _{x\rightarrow 0}\left(\dfrac{1+3x}{\sin x}-\dfrac{1}{x}\right)$ \quad \quad (ii)\, $\displaystyle \lim _{x\rightarrow 0^+}x^x$. \marks{5,4}
\item[(b)] \begin{itemize}
...
\item[(ii)] Verify Rolle's Theorem for $f(x)=x^2(1-x)^2, \, 0\leq x \leq 1$. \marks{5,4}
\end{itemize}
\item[(c)] Sketch the graph of $f(x)=\dfrac{x-1}{x+2}$ indicating any asymptotes and any points of intersection with the axes. \marks{10}
\end{itemize}
\end{question}
\begin{question}
\begin{itemize}
